...
(cl:defmethod cl:initialize-instance :after ((m <where>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'where)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name camera_show-msg:<where> is deprecated: use camera_show-msg:where instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <where>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader camera_show-msg:data-val is deprecated.  Use camera_show-msg:data instead.")
  (data m))
